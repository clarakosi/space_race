        ...
        <div>
          ...
          <div className="card border-dark" style={{backgroundColor: 'rgba(189,245,252,0.2)'}}>
            ...
            <div className="row my-auto visible" style={{margin: '-4px'}}>
              ...
              <div className="col"><button className="btn btn-primary btn-lg float-right" type="submit" style={{fontSize: 10, padding: 0, width: 55, margin: '15px 12px', height: 25}}>ADD</button></div></div>        
            ...
            <div className="card-body">
              <div className="row">
                ...
                <div className="col-auto">
                  <div className="form-check"><input className="form-check-input" type="radio" id="formCheck-1"  onChange={this.toggleCheck} checked={this.state.checked}/><label className="form-check-label" htmlFor="formCheck-1">Random Teams</label></div>
                </div>
              </div>
            </div>
          </div>
